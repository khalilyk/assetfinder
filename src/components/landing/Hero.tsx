...
export function Hero() {
  return (
    <section className="relative min-h-[560px] overflow-hidden md:aspect-[1672/941] md:min-h-0">
      ...
      <div className="absolute inset-0 mx-auto flex w-full max-w-7xl items-center px-6 md:px-10">
        <div className="max-w-lg">
          ...
          <Reveal delay={270}>
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a
                href="/contact"
                className="btn-glow group flex w-[200px] items-center justify-center gap-1.5 rounded-full bg-brand-lime px-5 py-3 text-sm font-semibold text-brand-dark transition duration-200 hover:scale-105 hover:bg-brand-lime-dark active:scale-95"
              >
                Book a demo
              ...
              <a
                href="#how-it-works"
                className="group flex w-[200px] items-center justify-center gap-2 rounded-full border border-white/20 px-5 py-3 text-sm font-semibold text-white transition duration-200 hover:scale-105 hover:border-white/40 active:scale-95"
              >
        ...
        <div className="absolute right-[50px] top-1/2 hidden w-72 -translate-y-1/2 md:block lg:w-80">
          <Reveal delay={200}>
            <div className="animate-float rounded-xl border border-white/10 bg-brand-dark-2/95 p-4 shadow-2xl shadow-black/40 backdrop-blur transition-shadow duration-500 hover:shadow-brand-lime/10">
