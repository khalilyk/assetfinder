...
export default function ScanPortalPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-brand-dark">
      <header className="grid grid-cols-[1fr_auto_1fr] items-center gap-4 px-6 py-6 md:px-10">
        <span />
        ...
        <a
          href="/contact"
          className="justify-self-end rounded-full border border-white/15 px-4 py-2 text-xs font-semibold text-white/70 transition hover:border-white/30 hover:text-white"
        >
          Support
        </a>
      </header>
